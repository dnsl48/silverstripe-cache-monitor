# Silverstripe Cache Monitor

Provides `/dev/cache-monitor` controller for your application that reflects
every cache backend (storage) configured in the Dependency Injection Container,
showing the utilisation stats.
